...
var render = function() {
  ...
  return _c("div", { staticClass: "relative" }, [
    _c(
      "div",
      { staticClass: "navbar", style: { backgroundColor: _vm.navbarColor } },
      [
        _c("div", { staticClass: "navbar w-100", class: _vm.classObj }, [
          _c("div", { staticClass: "navbar-brand" }, [
            _c(
              "div",
              { staticClass: "sm:inline-flex" },
              [
                _c("feather-icon", {
                  staticClass: "xl:hidden cursor-pointer mr-1",
                  attrs: { icon: "MenuIcon" },
                  on: {
                    click: function($event) {
                      $event.stopPropagation()
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  _c("p", { staticClass: "font-semibold pt-3" }, [
                ...
                [
                  _vm._l(_vm.sidebarItems, function(sidebarItem, index) {
                    return [
                      sidebarItem.header &&
                      !_vm.sidebarItemsMin &&
                      _vm.permission(sidebarItem.role)
                        ? _c(
                            "span",
                            {
                              key: "header-" + index,
...
module.exports = "/images/logo.png?f2aca36d6aa35852a5605b6f3897f01f";
