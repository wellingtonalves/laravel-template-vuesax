    ...
    <div>
        ...
        <div class="card w-full mh-100">
            <div class="card-body" v-if="visible">
                ...
                <products-form :errors="errors" :data="data" @update="update">
                    <template v-slot:buttons>
                        <button class="btn btn-primary" @click="save" type="submit">Salvar</button>
                        <button class="btn btn-danger" @click="goTo('/products')" type="submit">Cancelar</button>
                    </template>
                </products-form>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getData(uuid) {
                axios.get('/api/v1/products/' + uuid).then(response => {
            ...
            save() {
                ...
                axios.put('/api/v1/products/' + this.uuid, this.data).then(response => {
